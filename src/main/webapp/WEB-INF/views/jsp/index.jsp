...
<div class="container" id="page-wrapper">
    <c:choose>
        ...
        <c:when test="${flag eq 'article'}">
            <jsp:include page="index_articles.jsp" flush="true"/>
        </c:when>
        <c:when test="${flag eq 'category'}">
            <jsp:include page="index_atricle.jsp" flush="true"/>
        </c:when>
        <c:when test="${flag eq 'admin'}">
            <jsp:include page="index_admin.jsp" flush="true"/>
        </c:when>
    </c:choose>
</div>
